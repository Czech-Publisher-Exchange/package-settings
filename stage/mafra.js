window.cpexPublisherSettings = {
  ...
  formats: {
    ...
    native: {
      templates: {
        nativ: "<div class='art'> <a href='${link}' target='_blank' class='art-link'>\n    <h3>${title}</h3>\n    <div class='art-img w230'> <img src='${img}'> <span></span> </div>\n  </a>\n  <p class='perex'>${desc}</p>\n</div>",
        m_nativ: "<div class='art'> <a rel='sponsored' href='${link}' class='art-link' target='_blank'> <img title='' alt='' src='${img}' class='art-img sp5 ' width='100' height='75'>\n    <h3>${title}</h3>\n  </a></div>"
      },
      enabled: true
    }
  }
