  ...
  formats: {
    native: {
      ...
      templates: {
        ...
        mobile_square_2: "<style>   .cpex-native a {     display: flex;     text-decoration: none;     color: inherit   }   .cpex-native img {     width: 200px;     object-fit: cover   }   .cpex-custom .native-content {     display: block;   }   .cpex-custom .native-title {     font-size: 12pt;   }   .cpex-custom .native-content-img {     max-width: 65%;     width: 100%;     height: auto;   }   .cpex-custom .native-content-desc {     padding-top: 20px;   } </style> <div id='native' class='cpex-custom'>   <a href='${link}' target='_blank'>     <div class='native-content'>       <div class='native-content-img'><img src='${img}' alt=''></div>       <div class='native-content-desc'>         <div class='native-content-desc-text'>           <p class='native-title'>${title}</p>           <p id='nativeText'>${desc}</p>         </div>         <div class='native-info'><span class='info'>reklama</span></div>       </div>     </div>   </a> </div>"
      }
    },
    interscroller: {
