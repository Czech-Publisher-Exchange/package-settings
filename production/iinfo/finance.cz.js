  ...
  headerbidding: {
    adUnits: [{
      ...
      bids: [{
        ...
        bidder: 'triplelift',
        params: {
          inventoryCode: 'iINFO_financecz_halfpagehorni'
        }
      }, {
        bidder: 'r2b2',
        params: {
      ...
      bids: [{
        ...
        bidder: 'triplelift',
        params: {
          inventoryCode: 'iINFO_financecz_halfpagespodni'
        }
      }, {
        bidder: 'r2b2',
        params: {
      ...
      bids: [{
        ...
        bidder: 'triplelift',
        params: {
          inventoryCode: 'iINFO_financecz_leaderboard'
        }
      }, {
        bidder: 'r2b2',
        params: {
      ...
      bids: [{
        ...
        bidder: 'appnexus',
        params: {
          placementId: 20978756
        }
      }, {
        bidder: 'triplelift',
        params: {
          inventoryCode: 'iINFO_financecz_bigrectangle'
        }
      }, {
        bidder: 'r2b2',
        params: {
      ...
      bids: [{
        ...
        bidder: 'triplelift',
        params: {
          inventoryCode: 'iINFO_financecz_rectangle'
        }
      }, {
        bidder: 'r2b2',
        params: {
