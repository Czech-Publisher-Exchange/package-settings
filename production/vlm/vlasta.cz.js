  ...
  headerbidding: {
    adUnits: [{
      ...
      bids: [{
        ...
        bidder: 'triplelift',
        params: {
          inventoryCode: 'VLM_vlasta_leaderboard_bottom_2'
        }
      }],
      filter: {
        minWidth: 1000
      ...
      bids: [{
        ...
        bidder: 'triplelift',
        params: {
          inventoryCode: 'VLM_Vlasta_m-commercial-article-1'
        }
      }],
      filter: {
        maxWidth: 1000
      ...
      bids: [{
        ...
        bidder: 'triplelift',
        params: {
          inventoryCode: 'VLM_Vlasta_m-commercial-article-2'
        }
      }],
      filter: {
        maxWidth: 1000
      ...
      bids: [{
        ...
        bidder: 'triplelift',
        params: {
          inventoryCode: 'VLM_vlasta_skyscraper_gallery'
        }
      }],
      filter: {
        minWidth: 1000
  ...
  formats: {
    native: {
      ...
      templates: {
        ...
        generic: "<article class='flex flex-col gap-4 group/item w-full mb-8 lg:mb-7 last:mb-0 sm:flex-row'>\n  <a class='w-full h-auto shrink-0 sm:w-72 sm:h-48' href='${link}'>\n    <div class='-mx-4 sm:mx-0'>\n        <img src='${img}' class='object-center mx-auto max-h-screen bg-grey-1 object-cover aspect-3x2 w-full'>\n    </div>\n  </a>\n  <div class='flex flex-col items-start gap-2'>\n    <div class='flex flex-wrap gap-2'>\n      <a class='badge badge--link dark:bg-dark-grey-1 no-underline' href='#'>Reklama</a>\n    </div>\n    <h2 class='m-0 text-xl sm:text-2xl' style='text-align:left'>\n      <a class='no-underline group-hover/item:text-primary-2 dark:group-hover/item:text-dark-primary-2 text-inky dark:text-dark-inky' id='cXLinkIdltsoa93nn8eopce5' href='https://www.koktejl.cz/tipy-a-rady/tajemstvi-aerolinek-o-kterych-nemaji-pasazeri-ani-poneti/'>\n        ${title}\n      </a>\n    </h2>\n  </div>\n</article>"
      }
    },
    skin: {
      enabled: true,
