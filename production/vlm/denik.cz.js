  ...
  formats: {
    ...
    native: {
      ...
      templates: {
        ...
        'commercial-article-native-detail': "<article class='box-article box-article-classic mb25 hotjar-top16'>\n  <a class='box-article-left' href='${link}' title='${title}' tabindex='-1'>\n    <img src='${img}' width='210' height='140' class='box-article-img' loading='lazy'>\n  </a>\n  <div class='box-article-right'>\n    <div class='box-article-tags'>\n      <div class='box-article-tag'>REKLAMA</div>\n    </div>\n    <a class='box-article-perex fs16' href='${link}'>\n      <h3 class='box-article-title fs20'>${title}</h3>\n      ${desc}\n    </a>\n  </div>\n</article>"
      }
    },
    slideup: {
      enabled: true,
