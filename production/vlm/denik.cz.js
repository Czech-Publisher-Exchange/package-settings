  ...
  formats: {
    ...
    native: {
      ...
      templates: {
        ...
        'commercial-article-native-detail': "<article class='box-article box-article-classic' style='height: 130px'> <a class='box-article-left' href='${link}' target='_blank' title='${title}' tabindex='-1' style='display: flex; align-items: center' rel='sponsored noopener'> <img src='${img}' width='210' height='140' class='box-article-img' loading='lazy'> </a>\n  <div class='box-article-right'>\n    <div class='box-article-tags'>\n      <div class='box-article-tag'>REKLAMA</div>\n    </div> <a class='box-article-perex fs16' href='${link}' target='_blank' rel='sponsored noopener'>\n      <h3 class='box-article-title fs20'>${title}</h3> ${desc}\n    </a>\n  </div>\n</article>"
      }
    },
    slideup: {
      enabled: true,
