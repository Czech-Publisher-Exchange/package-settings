window.cpexWebsiteSettings = {
  ...
  formats: {
    ...
    responsive: {
      adUnits: ['m-square-1', 'm-square-2', 'm-seznam-feed'],
      width: 480,
      height: 480,
      enabled: true
    }
