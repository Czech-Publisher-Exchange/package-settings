  ...
  formats: {
    ...
    native: {
      ...
      templates: {
        ...
        'commercial-article-2-GA': "<style>  .cpex-native a { display: flex; text-decoration: none; color: inherit }  .cpex-native img { object-fit: cover; min-width: 16rem }</style><div class='cpex-native'>  <a href='${link}' target='_blank' rel='sponsored noopener' class='article-list__item article-list-item article-list-item--default'>    <img src='${img}'>    <div class='article-list-item__headline'>      <div class='article-box-a__tag'>        <span class='article-list-item__rubric'>Reklama</span>      </div>      <h2 class='article-list-item__title'>${title}</h2>      <div class='article-list-item__perex'>${desc}</div>    </div>  </a></div>",
