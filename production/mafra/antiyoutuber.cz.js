window.cpexWebsiteSettings = {
  ...
  headerbidding: {
    adUnits: [{
      ...
      code: 'halfpagead_fotogalerie_stredni',
      mediaTypes: {
        banner: {
          sizes: [
            [300, 600],
      ...
      code: 'halfpagead_fotogalerie_spodni',
      mediaTypes: {
        banner: {
          sizes: [
            [300, 600],
